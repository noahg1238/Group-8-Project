...
const reanimatedPolyfill = path.resolve(__dirname, "src/web/reanimated.polyfill.ts");
...
config.resolver.resolveRequest = (context, moduleName, platform) => {
	...
	if (platform === "web" && moduleName === "expo-sqlite") {
		const sqliteWebStub = path.resolve(__dirname, "src/database/sqlite.web.stub.ts");
