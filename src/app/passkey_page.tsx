              ...
              <View style={styles.keypadGrid}>
                {[
                  ...
                  <MotionView
                    key={row.join("-")}
                    enter="fadeUp"
                    delay={staggerMs(rowIndex, 45) + 100}
                ...
                >
                  ...
                  <PasskeyKey
                    onPress={removeDigit}
                    disabled={isBusy || showSuccess || pin.length === 0}
